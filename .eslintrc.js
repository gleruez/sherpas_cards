...
module.exports = {
  ...
  rules: {
    ...
    'no-restricted-imports': [
      ...
      {
        patterns: [
          { group: ['date-fns/*', '!date-fns/locale'], message: 'import from package root "date-fns"' },
          {
            group: ['lodash/*', '!lodash/cloneDeep'],
            message: 'import from package root "lodash"',
          },
          { group: ['@emotion/css', '@emotion/core'], message: 'import from "@emotion/react"' },
        ],
        paths: [
          {
            name: 'react',
          ...
          },
          {
            ...
            message: 'import from "@Test/test-utils" instead, which wraps @testing-library/react',
          },
          {
            name: 'react-router',
            importNames: ['useHistory, useLocation'],
            message: 'use next/router instead of react-router',
          },
          {
            name: 'react-router-dom',
            importNames: ['useHistory', 'useRouteMatch'],
            message: 'use next/router instead of react-router',
          },
        ],
      },
